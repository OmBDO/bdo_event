    ...
    return AnalyticsPanel(
      ...
      child: Row(
        children: [
          ...
          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text(title, style: TextStyle(color: palette.ink, fontWeight: FontWeight.w800)), const Gap(AppSpace.space4), Text(message, style: TextStyle(color: palette.muted, fontSize: AppSize.text12, height: 1.35))])),
        ],
      ),
    );
  }
