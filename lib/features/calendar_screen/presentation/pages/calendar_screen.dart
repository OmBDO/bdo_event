      ...
      child: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              SearchBarWidget(
                onChanged: context.read<CalendarScreenCubit>().updateSearchQuery,
              ),
              ...
              Builder(
                builder: (context) {
                  final visibleEvents = state.events.where((event) {
                    ...
                    return event.title.toLowerCase().contains(state.searchQuery) ||
                      event.location.toLowerCase().contains(state.searchQuery);
                  }).toList();
